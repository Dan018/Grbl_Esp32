...
//#define DRIVER(driver, axis) driver##Stepper = TRINAMIC_axis## = driver##Stepper(axis##_CS_PIN, axis##_RSENSE);
        ...
        TMC2130Stepper TRINAMIC_X2 = TMC2130Stepper(X2_CS_PIN, X2_RSENSE, X2_DRIVER_SPI_INDEX);
    #endif
    #ifdef X2_DRIVER_TMC2209
        TMC2209Stepper TRINAMIC_X2 = TMC2209Stepper(X2_CS_PIN, X2_RSENSE, X2_DRIVER_SPI_INDEX);
    #endif
    #ifdef X2_DRIVER_TMC5160
        TMC5160Stepper TRINAMIC_X2 = TMC5160Stepper(X2_CS_PIN, X2_RSENSE, X2_DRIVER_SPI_INDEX);
    #endif
#endif
        ...
        TMC2130Stepper TRINAMIC_Y2 = TMC2130Stepper(Y2_CS_PIN, Y2_RSENSE, Y2_DRIVER_SPI_INDEX);
    #endif
    #ifdef Y2_DRIVER_TMC2209
        TMC2209Stepper TRINAMIC_Y2 = TMC2209Stepper(Y2_CS_PIN, Y2_RSENSE, Y2_DRIVER_SPI_INDEX);
    #endif
    #ifdef Y2_DRIVER_TMC5160
        TMC5160Stepper TRINAMIC_Y2 = TMC5160Stepper(Y2_CS_PIN, Y2_RSENSE, Y2_DRIVER_SPI_INDEX);
    #endif
#endif
        ...
        TMC2130Stepper TRINAMIC_Z2 = TMC2130Stepper(Z2_CS_PIN, Z2_RSENSE, Z2_DRIVER_SPI_INDEX);
    #endif
    #ifdef Z2_DRIVER_TMC2209
        TMC2209Stepper TRINAMIC_Z2 = TMC2209Stepper(Z2_CS_PIN, Z2_RSENSE, Z2_DRIVER_SPI_INDEX);
    #endif
    #ifdef Z2_DRIVER_TMC5160
        TMC5160Stepper TRINAMIC_Z2 = TMC5160Stepper(Z2_CS_PIN, Z2_RSENSE, Z2_DRIVER_SPI_INDEX);
    #endif
#endif
...
void Trinamic_Init() {
    ...
    trinamic_test_response(TRINAMIC_X.test_connection(), "X2");
